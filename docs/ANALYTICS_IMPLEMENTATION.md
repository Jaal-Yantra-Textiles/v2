...
✅ **No PII**: Visitor IDs are hashed fingerprints
✅ **Country-level Only**: No city/region tracking
✅ **No Cross-site Tracking**: Each website isolated
...
See [Analytics Test README](../integration-tests/http/analytics/README.md) for details.
