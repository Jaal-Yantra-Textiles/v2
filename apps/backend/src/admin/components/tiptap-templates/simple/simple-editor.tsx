...
export function SimpleEditor({
  ...
  const handleContentChange = React.useCallback(() => {
    if (!editor || !onSetEditorContent) return
  ...
  const editor = useEditor({
    ...
    editorProps: {
      ...
      handleDOMEvents: {
        keydown: () => false, // Allow all keydown events
        mousedown: () => false, // Allow all mousedown events
        focus: () => false, // Allow focus events
      },
    },
    extensions: [
  ...
  React.useEffect(() => {
    if (editor && initialEditorContent !== undefined) {
  ...
  return (
    <EditorContext.Provider value={{ editor }}>
      ...
      <div className="content-wrapper">
        <div className={`${editorIsLoading ? 'opacity-50 cursor-wait' : ''} relative h-full`}>
          <EditorContent
            editor={editor}
            role="presentation"
