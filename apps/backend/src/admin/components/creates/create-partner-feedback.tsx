...
import { useCreatePartnerFeedback } from "../../hooks/api/feedbacks";
...
type CreatePartnerFeedbackFormProps = {
  partnerId: string;
};

export const CreatePartnerFeedbackForm = ({ partnerId }: CreatePartnerFeedbackFormProps) => {
  const { handleSuccess } = useRouteModal();
  const { mutateAsync, isPending } = useCreatePartnerFeedback(partnerId);
  ...
  const fields: FieldConfig<FeedbackFormData>[] = [
    ...
    },
    {
      ...
      label: "Comment",
      type: "text",
      hint: "Enter your feedback about this partner",
    },
    {
      name: "status",
      label: "Status",
