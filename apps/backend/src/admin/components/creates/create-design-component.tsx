...
/**
 * Bundle another design into this one as a component.
 *
 * Lifted out of `routes/designs/[id]/@add-component/page.tsx` so the design
 * graph can open the same form its route does — chrome and "done" come from
 * whichever shell wraps it.
 */
export const AddDesignComponentForm = ({ designId }: { designId: string }) => {
  ...
  return (
    <>
      ...
      <Chrome.Body className="flex flex-col items-center py-16">
