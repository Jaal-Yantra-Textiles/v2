...
/**
 * Weaver "edit / changes" editor, rendered in a RouteDrawer (the metadata-style
 * pattern). Persists to the person_property record keyed by census_id
      ...
      <RouteDrawer.Footer>
        <div className="flex items-center justify-end gap-x-2">
          <RouteDrawer.Close asChild>
            <Button size="small" variant="secondary" type="button" disabled={update.isPending}>
              Cancel
            </Button>
          </RouteDrawer.Close>
          <Button size="small" type="button" onClick={save} isLoading={update.isPending}>
            Save
          </Button>
        </div>
      </RouteDrawer.Footer>
