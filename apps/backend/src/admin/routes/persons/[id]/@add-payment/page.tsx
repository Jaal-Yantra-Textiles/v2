...
import { useListPersonPaymentMethods } from "../../../../hooks/api/payment-methods";
import { useCreatePaymentAndLink } from "../../../../hooks/api/payments";

const AddPaymentForPerson = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const { paymentMethods } = useListPersonPaymentMethods(id!);
    ...
    <RouteDrawer>
      <RouteDrawer.Header>
        ...
        <RouteDrawer.Description>
          Create a payment for this person and optionally link a payment method.
        </RouteDrawer.Description>
      </RouteDrawer.Header>
...
export default AddPaymentForPerson;
