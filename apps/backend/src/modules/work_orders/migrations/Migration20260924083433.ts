...
export class Migration20260924083433 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table if not exists "work_order_item" ("id" text not null, "title" text not null, "subtitle" text null, "thumbnail" text null, "quantity" numeric not null, "unit_price" numeric not null, "design_id" text null, "production_run_id" text null, "cost_type" text check ("cost_type" in ('per_unit', 'total')) null, "cost_estimate" numeric null, "inventory_item_id" text null, "inventory_order_line_id" text null, "work_order_id" text not null, "raw_quantity" jsonb not null, "raw_unit_price" jsonb not null, "raw_cost_estimate" jsonb null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "work_order_item_pkey" primary key ("id"));`);
