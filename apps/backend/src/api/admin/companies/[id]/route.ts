...
import { companyUpdateSchema } from "../../../investors/validators"
...
// POST /admin/companies/:id — update company (compliance: reg no, tax id, status,
// founded date, dashboard toggle, …). Reuses the shared companyUpdateSchema.
