...
export const EmailTemplateSchema = z.object({
  ...
  to: z.union([z.email(), z.literal(""), z.null()]).optional().transform(val => val === "" ? null : val),
  cc: z.union([z.email(), z.literal(""), z.null()]).optional().transform(val => val === "" ? null : val),
  bcc: z.union([z.email(), z.literal(""), z.null()]).optional().transform(val => val === "" ? null : val),
  from: z.email(),
