...
export const useCreatePaymentCollection = (
  ...
  return useMutation({
    mutationFn: (payload) =>
      sdk.client.fetch(`/partners/payment-collections`, { method: "POST", body: payload }),
...
export const useMarkPaymentCollectionAsPaid = (
  ...
  return useMutation({
    mutationFn: (payload) =>
      sdk.client.fetch(`/partners/payment-collections/${paymentCollectionId}/mark-as-paid`, { method: "POST", body: payload }),
    onSuccess: (data, variables, context) => {
      queryClient.invalidateQueries({
        queryKey: ordersQueryKeys.details(),
      })
...
export const useDeletePaymentCollection = (
  ...
  return useMutation({
    mutationFn: (id: string) =>
      sdk.client.fetch(`/partners/payment-collections/${id}`, { method: "DELETE" }),
    onSuccess: (data, variables, context) => {
      queryClient.invalidateQueries({
        queryKey: ordersQueryKeys.details(),
      })
