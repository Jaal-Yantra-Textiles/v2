...
- [AI_CHAT_V3.md](AI_CHAT_V3.md) - AI Chat V3 overview
- [AI_CHAT_V3_ENHANCED_RAG_PROPOSAL.md](AI_CHAT_V3_ENHANCED_RAG_PROPOSAL.md) - Enhanced RAG system proposal
- [AI_CHAT_V3_IMPLEMENTATION.md](AI_CHAT_V3_IMPLEMENTATION.md) - Implementation details
