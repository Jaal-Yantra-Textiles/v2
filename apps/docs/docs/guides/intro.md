...
Step-by-step instructions for setting up and using JYT Commerce features. Written for end users, partners, and operators.
...
- **[Inventory](/docs/guides/inventory/receiving-and-moving-material)** - Receiving material onto our books, and moving it between locations once it is here
...
- **[Testing](/docs/guides/testing/ui-testing-checklist)** - UI testing checklists and verification
- **[Migration](/docs/guides/migration/migration-guide)** - Upgrading between versions
