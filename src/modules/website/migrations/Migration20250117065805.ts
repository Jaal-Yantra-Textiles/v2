...
export class Migration20250117065805 extends Migration {
  ...
  async down(): Promise<void> {
    this.addSql('alter table if exists "website_page" drop constraint if exists "website_page_website_id_foreign";');
