...
/**
 * Add `generate_partner_deeplink` to the visual_flow_operation.operation_type
 * whitelist. Paired with the new operation at
 * src/modules/visual_flows/operations/generate-partner-deeplink.ts.
 */
export class Migration20260420090000 extends Migration {
