...
// Export the schema
export const AdminPostInventoryOrderTasksReq = z.discriminatedUnion("type", [
...
export type AdminPostInventoryOrderTasksReqType = z.infer<typeof AdminPostInventoryOrderTasksReq>
