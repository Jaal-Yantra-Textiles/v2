...
export const DEFAULT_HIGHLIGHT_COLORS: ColorHighlightPopoverColor[] = [
  {
    label: "Green",
    value: "rgba(34, 197, 94, 0.3)", // green with opacity for better contrast
    border: "#22c55e",
  },
  {
    label: "Blue",
    value: "rgba(59, 130, 246, 0.3)", // blue with opacity
    border: "#3b82f6",
  },
  {
    label: "Red",
    value: "rgba(239, 68, 68, 0.3)", // red with opacity
    border: "#ef4444",
  },
  {
    label: "Purple",
    value: "rgba(168, 85, 247, 0.3)", // purple with opacity
    border: "#a855f7",
  },
  {
    label: "Yellow",
    value: "rgba(234, 179, 8, 0.4)", // yellow with higher opacity for visibility
    border: "#eab308",
  },
]
...
export function ColorHighlightPopoverContent({
  ...
  return (
    <div
      ref={containerRef}
      className="tiptap-color-highlight-content bg-ui-bg-base border-ui-border-base text-ui-fg-base"
      tabIndex={0}
    >
